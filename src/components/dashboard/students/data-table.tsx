...
import { useDeleteAllStudents } from "@/hooks/students/use-students";
import { toast } from "sonner";
import { DeleteAllStudentsDialog } from "./delete-all-students-dialog";
...
export function DataTable<TData, TValue>({
	...
	const { deleteAllStudents, loading: deleteAllLoading } =
	...
	const handleDeleteAll = async () => {
		...
		if (result.success) {
			toast.success("All students deleted successfully!", {
				description: `${result.deletedCount} students have been removed from the system.`,
			});
			onDeleteAllSuccess?.();
		...
		<div className="w-full space-y-4">
			...
			<div className="flex flex-col gap-4 md:flex-row md:justify-between md:items-center">
				<div className="flex flex-wrap gap-2">
					<AddStudentDialog onSuccess={onAddSuccess} />
					<Button
						variant="destructive"
